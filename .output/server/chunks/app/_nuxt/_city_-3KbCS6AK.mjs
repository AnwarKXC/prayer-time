import { u as useI18n, d as useRoute, b as __nuxt_component_0$3, e as __nuxt_component_2$2, a as __nuxt_component_0$2$1, _ as _export_sfc } from '../server.mjs';
import { withAsyncContext, ref, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext, renderSlot } from 'vue';
...
import { u as useFetch, _ as __nuxt_component_0$2, a as __nuxt_component_2, b as __nuxt_component_3$1, c as __nuxt_component_5$1, d as __nuxt_component_6 } from './Add4-Ccn-Ej9v.mjs';
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (props.data[0]) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "overflow-hidden" }, _attrs))}><div class="w-full overflow-x-auto bg-yellow-50 rounded-[10px] border border-sec flex justify-between whitespace-nowrap items-center"><!--[-->`);
        ssrRenderList(prayerTimes, (prayer, index) => {
          _push(`<div class="${ssrRenderClass([{ "bg-sec ": nextPrayerIndex.value === index }, "cent__col gap-1 py-2 min-w-[110px] px-5"])}">`);
          ...
          _push(`<div class="${ssrRenderClass([{ "!text-white ": nextPrayerIndex.value === index }, "text-right text-zinc-500 text-sm font-normal font-['Almarai'] leading-tight"])}">${ssrInterpolate(_ctx.$t(prayer.translation))}</div><div class="${ssrRenderClass([{ "!text-white ": nextPrayerIndex.value === index }, "text-right text-zinc-800 text-base font-medium font-['Roboto'] leading-tight"])}">${ssrInterpolate(props.data[0].timings[prayer.key])}</div></div>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
    to: "/",
    class: "w-full h-[77px] bg-white rounded-[10px] border border-gray-300 grid grid-cols-5 gap-5 p-3"
  }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="cent"${_scopeId}>`);
        ssrRenderSlot(_ctx.$slots, "image", {}, null, _push2, _parent2, _scopeId);
        _push2(`</div><div class="flex items-center col-span-4"${_scopeId}><div class="grid"${_scopeId}><div class="text-zinc-800 font-semibold"${_scopeId}>`);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Image = __nuxt_component_0$3;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-[10px] border border-gray-200 px-4 py-6 grid gap-6" }, _attrs))}><h2 class="h__primary">${ssrInterpolate(_ctx.$t("playbanner.heading"))}</h2><div class="tracks__grid"><!--[-->`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-[10px] border border-gray-200 px-4 py-6 grid gap-6" }, _attrs))}><h2 class="h__primary">${ssrInterpolate(_ctx.$t("trendingbanner.heading"))}</h2><div class="popular__articles__grid"><!--[-->`);
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: cleander } = ([__temp, __restore] = withAsyncContext(() => useFetch(times + "&country=" + route.params.country, "$HmUGuAd7PV")), __temp = await __temp, __restore(), __temp);
    ...
    const { data: cities } = ([__temp, __restore] = withAsyncContext(() => useFetch(domain + getAllCitiesInCountry + route.params.id + "&locale[0]=" + locale.value, "$kkFiBGLkU9")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Add4 = __nuxt_component_6;
      ...
      if (unref(cities).data[0]) {
        _push(`<!--[-->${ssrInterpolate(_ctx.$t(unref(cities).data[0].attributes.prayer_time_country.data.attributes.name))}<!--]-->`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<h2 class="h__primary">${ssrInterpolate(_ctx.$t("infobanner.monthsubheading"))}</h2><div class="overflow-x-auto"><div class="flex gap-4 whitespace-nowrap text-zinc-500">`);
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(displayedData), (day) => {
              ...
              _push2(ssrRenderComponent(_component_Td, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(day.timings.Fajr)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(day.timings.Fajr), 1)
                    ];
                  }
                }),
                _: 2
              ...
              _push2(ssrRenderComponent(_component_Td, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(day.timings.Sunrise)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(day.timings.Sunrise), 1)
                    ];
                  }
                }),
                _: 2
              ...
              _push2(ssrRenderComponent(_component_Td, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(day.timings.Dhuhr)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(day.timings.Dhuhr), 1)
                    ];
                  }
                }),
                _: 2
              ...
              _push2(ssrRenderComponent(_component_Td, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(day.timings.Asr)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(day.timings.Asr), 1)
                    ];
                  }
                }),
                _: 2
              ...
              _push2(ssrRenderComponent(_component_Td, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(day.timings.Maghrib)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(day.timings.Maghrib), 1)
                    ];
                  }
                }),
                _: 2
              ...
              _push2(ssrRenderComponent(_component_Td, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(day.timings.Isha)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(day.timings.Isha), 1)
                    ];
                  }
                }),
                _: 2
      ...
      ssrRenderList(unref(cities).data, (city) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/" + unref(route).params.country + "/" + unref(route).params.id + "/" + city.id,
          key: city.id,
          class: "w-full"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(ssrRenderComponent(_component_Add4, null, null, _parent));
      _push(`</div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/[country]/[id]/[city].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_city_-3KbCS6AK.mjs.map
