import {
   ...
   d as useRoute,
   e as useFetch,
   b as __nuxt_component_0$3,
   f as __nuxt_component_2$2,
   a as __nuxt_component_0$2$1,
   _ as _export_sfc,
} from "./server.mjs"
import {
   withAsyncContext,
...
import {
   _ as __nuxt_component_0$2,
   a as __nuxt_component_2,
   b as __nuxt_component_3$1,
   c as __nuxt_component_5$1,
   d as __nuxt_component_6,
} from "./NativePanners-BhyqnIoU.mjs"
import "../runtime.mjs"
import "node:http"
import "node:https"
import "fs"
   ...
   setup(__props) {
      ...
      return (_ctx, _push, _parent, _attrs) => {
         ...
         if (props.data[0]) {
            _push(
               `<div${ssrRenderAttrs(
                  mergeProps({ class: "overflow-hidden" }, _attrs),
               )}><div class="w-full overflow-x-auto bg-yellow-50 rounded-xl border border-sec flex justify-between whitespace-nowrap items-center"><!--[-->`,
            )
            ssrRenderList(prayerTimes, (prayer, index) => {
               _push(
                  `<div class="${ssrRenderClass([
                     { "bg-sec ": nextPrayerIndex.value === index },
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
   _push(
      `<div${ssrRenderAttrs(
         mergeProps({ class: "overflow-x-auto" }, _attrs),
      )}><table class="overflow-hidden rounded-xl w-full text-xs whitespace-nowrap mb-0.5 drop-shadow-sm"><thead><tr class="bg-primary text-white h-[33px]">`,
   )
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [
   ...
   setup(__props) {
      return (_ctx, _push, _parent, _attrs) => {
         _push(
            ...
            )}>${ssrInterpolate(_ctx.$t(__props.thText))} `,
         )
...
const _sfc_main$6 = {
   ...
   setup(__props) {
      return (_ctx, _push, _parent, _attrs) => {
         _push(
            `<td${ssrRenderAttrs(
               mergeProps({ class: "px-3" }, _attrs),
            )}><div class="${ssrRenderClass(__props.tdClass)}">`,
         )
         ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent)
         _push(`</div></td>`)
      }
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
   _push(
      ...
      )}><div class="font-normal font-[&#39;Almarai&#39;]">`,
   )
   ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent)
   _push(`</div></div>`)
}
...
_sfc_main$5.setup = (props, ctx) => {
   const ssrContext = useSSRContext()
   ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
      "components/CityLabel.vue",
   )
   return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0
}
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [
         ...
         ),
         {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
               if (_push2) {
                  ...
                  _push2(
                     `</div><div class="flex items-center col-span-4"${_scopeId}><div class="grid"${_scopeId}><div class="text-zinc-800 font-semibold"${_scopeId}>`,
                  )
                  ssrRenderSlot(_ctx.$slots, "title", {}, null, _push2, _parent2, _scopeId)
                  _push2(`</div><div class="text-neutral-400"${_scopeId}>`)
                  ssrRenderSlot(_ctx.$slots, "by", {}, null, _push2, _parent2, _scopeId)
                  _push2(`</div></div></div>`)
               } else {
                  return [
                     createVNode("div", { class: "cent" }, [renderSlot(_ctx.$slots, "image")]),
                     createVNode("div", { class: "flex items-center col-span-4" }, [
                        createVNode("div", { class: "grid" }, [
                           createVNode("div", { class: "text-zinc-800 font-semibold" }, [
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
   ...
   _push(
      ...
      )}><h2 class="h__primary">${ssrInterpolate(
         _ctx.$t("playbanner.heading"),
      )}</h2><div class="tracks__grid"><!--[-->`,
   )
   ssrRenderList(6, (index) => {
      _push(
         ssrRenderComponent(
            _component_TrackCard,
            {
               key: index,
            },
            {
...
_sfc_main$3.setup = (props, ctx) => {
   const ssrContext = useSSRContext()
   ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
      "components/AllTracks.vue",
   )
   return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0
}
const __nuxt_component_11 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
   ...
   _push(
      `</div><div class="row-span-2 grid gap-2 p-3"><div class="text-zinc-800 text-lg truncate">`,
   )
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
   ...
   _push(
      `<div${ssrRenderAttrs(
         ...
         _ctx.$t("trendingbanner.heading"),
      )}</h2><div class="popular__articles__grid"><!--[-->`,
   )
   ssrRenderList(3, (index) => {
      _push(
         ssrRenderComponent(
            _component_ArticleCard,
            {
               key: index,
            },
            {
               image: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                     _push2(
                        `<img class="w-full h-full" src="https://via.placeholder.com/266x185"${_scopeId}>`,
                     )
                  } else {
                     return [
                        createVNode("img", {
...
_sfc_main$1.setup = (props, ctx) => {
   const ssrContext = useSSRContext()
   ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
      "components/PopularArticlesSec.vue",
   )
   return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0
}
const __nuxt_component_12 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [
...
const _sfc_main = {
   ...
   async setup(__props) {
      ...
      const {
         ...
         useFetch(
            times + "&country=" + route.params.country,
            {
      ...
      const getAllCitiesInCountry =
         "/api/prayer-time-cities/?isHardPopulate=true&filters[prayer_time_country][id][$eq]="
      const { data: cities } =
         (([__temp, __restore] = withAsyncContext(() =>
            useFetch(
               domain + getAllCitiesInCountry + route.params.id + "&locale[0]=" + locale.value,
               "$vGhPyrTOp7",
            ),
         )),
         (__temp = await __temp),
      ...
      const startIndex = ref(
         dayOfMonth <= 7 ? 0 : dayOfMonth <= 14 ? 7 : dayOfMonth <= 21 ? 14 : 21,
      )
      ...
      return (_ctx, _push, _parent, _attrs) => {
         ...
         _push(
            `<div${ssrRenderAttrs(
               mergeProps({ class: "grid gap-6" }, _attrs),
            )}><div><img class="w-full h-[244px] rounded-xl border border-gray-300" src="https://via.placeholder.com/909x244"></div><div class="bg-white rounded-xl border border-gray-200 grid gap-6 px-4 py-6"><h2 class="h__primary">${ssrInterpolate(
               _ctx.$t("infobanner.topheading"),
            )}</h2><div class="h-[0px] rotate-180 border border-stone-300"></div><div class="grid md:grid-cols-2 gap-4 items-center"><div class="flex gap-3 items-center"><div class="w-16 h-16 rounded-lg border border-gray-200 p-1.5 cent overflow-hidden">`,
         )
         if (
            unref(cities).data[0].attributes.prayer_time_country.data.attributes.flag.data
               .attributes
         ) {
            _push(
               `<img${ssrRenderAttr(
         ...
         _push(
            `</div><div class="grid gap-2"><div class="text-zinc-700 text-[17px] font-bold font-[&#39;Almarai&#39;] leading-tight">${ssrInterpolate(
               _ctx.$t("infobanner.countryheading"),
            )} `,
         )
         ...
         _push(
            `</div><div class="text-zinc-800 text-xs font-normal font-[&#39;Almarai&#39;] leading-tight">${ssrInterpolate(
               _ctx.$t("infobanner.countrysubheading"),
            )} `,
         )
         if (unref(cities).data[0]) {
            _push(`<!--[-->`)
         ...
         if (filteredEntries.value[0]) {
            _push(
               `<!--[-->${ssrInterpolate(
                  filteredEntries.value[0].date.hijri.weekday.ar,
               )}\xA0 ${ssrInterpolate(
                  filteredEntries.value[0].date.hijri.day,
               )}\xA0 ${ssrInterpolate(
                  filteredEntries.value[0].date.hijri.month.ar,
               )}\xA0 ${ssrInterpolate(
                  filteredEntries.value[0].date.hijri.year,
               )}\xA0 ${ssrInterpolate(_ctx.$t("infobanner.para2"))}\xA0 ${ssrInterpolate(
                  filteredEntries.value[0].date.gregorian.date,
               )}\xA0 <!--]-->`,
            )
         } else {
            _push(`<!---->`)
         ...
         _push(
            `</div></div></div></div><div class="grid md:grid-cols-3 gap-4"><div class="flex gap-2"><div class="text-teal-900 text-sm font-bold font-[&#39;Almarai&#39;] leading-tight">${ssrInterpolate(
               _ctx.$t("infobanner.calpara"),
            )}</div><div class="text-zinc-800 text-sm font-normal font-[&#39;Almarai&#39;] leading-tight">`,
         )
         if (filteredEntries.value[0]) {
         ...
         _push(
            `</div></div><div class="flex gap-2 md:justify-center"><div class="text-teal-900 text-sm font-bold font-[&#39;Almarai&#39;] leading-tight">${ssrInterpolate(
               _ctx.$t("infobanner.doctrinepara"),
            )}</div><div class="text-zinc-800 text-sm font-normal font-[&#39;Almarai&#39;] leading-tight"> \u0634\u0627\u0641\u0639\u064A\u060C \u062D\u0646\u0628\u0644\u064A\u060C \u0645\u0627\u0644\u0643\u064A</div></div><div class="flex gap-2"><div class="text-teal-900 text-sm font-bold font-[&#39;Almarai&#39;] leading-tight">${ssrInterpolate(
               _ctx.$t("infobanner.timestyle"),
            )}</div><div class="text-zinc-800 text-sm font-normal font-[&#39;Almarai&#39;] leading-tight"> \u062A\u0646\u0633\u064A\u0642 24 \u0633\u0627\u0639\u0629</div></div></div><div class="flex gap-2 items-center"><div class="text-zinc-700 text-lg font-bold font-[&#39;Almarai&#39;] leading-tight">${ssrInterpolate(
               _ctx.$t("infobanner.timepara"),
            )}</div><div class="text-zinc-500 text-xs font-normal font-[&#39;Almarai&#39;] leading-tight">${ssrInterpolate(
               _ctx.$t("infobanner.timingsubheading"),
            )}</div></div>`,
         )
         _push(
            ssrRenderComponent(
               _component_PrayingToday,
               {
         ...
         _push(
            `<h2 class="h__primary">${ssrInterpolate(
               _ctx.$t("infobanner.monthsubheading"),
            )}</h2><div class="overflow-x-auto pb-1"><div class="flex gap-4 whitespace-nowrap text-zinc-500">`,
         )
         _push(
            ssrRenderComponent(
               _component_Button,
                     ...
                     if (_push2) {
                        ...
                        ssrRenderList(unref(displayedData), (day) => {
                           _push2(
                              `<tr class="${ssrRenderClass([
                                 formattedDate.value === day.date.gregorian.date
                                    ? "!bg-yellow-50 "
                                    : "",
                                 "h-[45px] border-b",
                              ])}"${_scopeId}>`,
                                 ...
                                 },
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          ...
                                          return [
                                             createTextVNode(
                                                toDisplayString(day.date.gregorian.date),
                                                1,
                                             ),
                                          ]
                                       }
                                 ...
                                 null,
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          ...
                                          return [
                                             createTextVNode(
                                                toDisplayString(extractTime(day.timings.Fajr)),
                                                1,
                                             ),
                                          ]
                                       }
                              ...
                              ssrRenderComponent(
                                 ...
                                 null,
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          _push3(
                                             `${ssrInterpolate(extractTime(day.timings.Sunrise))}`,
                                          )
                                       } else {
                                          return [
                                             createTextVNode(
                                                toDisplayString(extractTime(day.timings.Sunrise)),
                                                1,
                                             ),
                                          ]
                                       }
                              ...
                              ssrRenderComponent(
                                 ...
                                 null,
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          _push3(
                                             `${ssrInterpolate(extractTime(day.timings.Dhuhr))}`,
                                          )
                                       } else {
                                          return [
                                             createTextVNode(
                                                toDisplayString(extractTime(day.timings.Dhuhr)),
                                                1,
                                             ),
                                          ]
                                       }
                                 ...
                                 null,
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          ...
                                          return [
                                             createTextVNode(
                                                toDisplayString(extractTime(day.timings.Asr)),
                                                1,
                                             ),
                                          ]
                                       }
                              ...
                              ssrRenderComponent(
                                 ...
                                 null,
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          _push3(
                                             `${ssrInterpolate(extractTime(day.timings.Maghrib))}`,
                                          )
                                       } else {
                                          return [
                                             createTextVNode(
                                                toDisplayString(extractTime(day.timings.Maghrib)),
                                                1,
                                             ),
                                          ]
                                       }
                                 ...
                                 null,
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          ...
                                          return [
                                             createTextVNode(
                                                toDisplayString(extractTime(day.timings.Isha)),
                                                1,
                                             ),
                                          ]
                                       }
                        ...
                        return [
                           ...
                           createBlock(
                              Fragment,
                              null,
                              renderList(unref(displayedData), (day) => {
                                 return (
                                    openBlock(),
                                    createBlock(
                                       "tr",
                                          ...
                                          createVNode(
                                             ...
                                             null,
                                             {
                                                default: withCtx(() => [
                                                   createTextVNode(
                                                      toDisplayString(
                                                         extractTime(day.timings.Sunrise),
                                                      ),
                                                      1,
                                                   ),
                                                ]),
                                          ...
                                          createVNode(
                                             ...
                                             null,
                                             {
                                                default: withCtx(() => [
                                                   createTextVNode(
                                                      toDisplayString(
                                                         extractTime(day.timings.Maghrib),
                                                      ),
                                                      1,
                                                   ),
                                                ]),
         ...
         _push(
            `<div class="bg-white rounded-xl border border-gray-200 px-4 py-6 grid gap-6"><h2 class="h__primary">${ssrInterpolate(
               _ctx.$t("citiescounrybanner.heading"),
            )}</h2><div class="city__label__grid"><!--[-->`,
         )
         ssrRenderList(unref(cities).data, (city) => {
            _push(
               ssrRenderComponent(
                                 ...
                                 null,
                                 {
                                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          ...
                                          return [
                                             createTextVNode(
                                                toDisplayString(city.attributes.title),
                                                1,
                                             ),
                                          ]
                                       }
...
//# sourceMappingURL=_city_-Bxb56ve6.mjs.map
