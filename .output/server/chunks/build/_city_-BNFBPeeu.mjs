import { u as useI18n, b as useRoute, d as useFetch, e as __nuxt_component_1$4, f as __nuxt_component_2$1, a as __nuxt_component_0$2 } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: cleander, error, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch(times + route.params.id + "&country=" + route.params.country, {
      watch: route.params.city
    }, "$dOKslVFzLf")), __temp = await __temp, __restore(), __temp);
    ...
    const { data: cities } = ([__temp, __restore] = withAsyncContext(() => useFetch(domain + getAllCitiesInCountry + route.params.city + "&locale[0]=" + locale.value, "$XOTXjHJLzA")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(cities).data, (city) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/app/prayer-time/" + unref(route).params.country + "/" + city.attributes.slug + "/" + unref(route).params.city,
          key: city.id,
          class: "w-full"
        }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/app/prayer-time/[country]/[id]/[city].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_city_-BNFBPeeu.mjs.map
