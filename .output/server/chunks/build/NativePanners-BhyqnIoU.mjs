   ...
   async setup(__props) {
      ...
      const { data: landingData } =
         (([__temp, __restore] = withAsyncContext(() =>
            useFetch(domain + landing + locale.value, "$KLLiPgUiit"),
         )),
         (__temp = await __temp),
         __restore(),
         __temp)
      const links = landingData.value.data.attributes.branding
      const activeBanners = landingData.value.data.attributes.banners_native.filter(
      ...
      return (_ctx, _push, _parent, _attrs) => {
         ...
         _push(
            `<div${ssrRenderAttrs(
               mergeProps(
                  {
                     class: "min-h-[244px] bg-white rounded-xl border border-gray-200 main__banner",
                  },
                  _attrs,
               ),
            )}><div class="cent h-full w-full"><div class="relative md:grid grid-cols-4 p-4 gap-1 w-full"><div class="md:col-span-3 flex items-center size-full"><div class="grid gap-4"><div class="text-zinc-700 md:text-[15px] text-[13px] font-normal font-[&#39;Almarai&#39;]">${ssrInterpolate(
               unref(activeOne).sub_title,
            )}</div><h2 class="h__primary max-w-[600px] max-md:max-w-[500px] leading-10">${ssrInterpolate(
               unref(activeOne).title,
            )}</h2><div class="flex">`,
         )
         _push(
            ssrRenderComponent(
               ...
               },
               {
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                     if (_push2) {
                        _push2(`${ssrInterpolate(unref(links).title_download)}`)
                     } else {
                        return [createTextVNode(toDisplayString(unref(links).title_download), 1)]
                     }
                  }),
                  _: 1,
               },
         ...
         _push(
            `</div></div></div><div class="flex md:justify-center justify-end items-center max-md:absolute rtl:left-0 ltr:right-0 bottom-0 max-md:size-[120px] max-xs:size-[90px] size-full ltr:scale-x-[-1] transform max-md:mx-4 md:w-full"><img${ssrRenderAttr(
               "src",
               unref(domain) + unref(activeOne).image.data.attributes.url,
            )} alt="" class="rounded w-full"></div></div></div></div>`,
         )
      }
   },
}
...
_sfc_main$5.setup = (props, ctx) => {
   const ssrContext = useSSRContext()
   ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
      "components/CountryCard.vue",
   )
   return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0
}
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
   _push(
      `<nav${ssrRenderAttrs(
         mergeProps({ "aria-label": "pagenation" }, _attrs),
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [
...
const _sfc_main$3 = {
   ...
   async setup(__props) {
      ...
      const { data: regions } =
         (([__temp, __restore] = withAsyncContext(() =>
            useFetch(domain + getAllRegions + locale.value, "$bEX2bdNytm"),
         )),
         (__temp = await __temp),
         __restore(),
         __temp)
      const { data: countries } =
         (([__temp, __restore] = withAsyncContext(() =>
            useFetch(domain + getAllCountrys + locale.value, "$gB3TferGDD"),
         )),
         (__temp = await __temp),
         __restore(),
         __temp)
      return (_ctx, _push, _parent, _attrs) => {
         ...
         _push(
            ...
            )}><div class="grid gap-4"><div class="flex justify-between items-center gap-4 flex-wrap"><h2 class="h__primary">${ssrInterpolate(
               _ctx.$t("allcountries.heading"),
            )}</h2><div class="flex md:gap-[21px] gap-4 text-[#828282] flex-wrap"><!--[-->`,
         )
                  ...
                  },
                  {
                     default: withCtx((_, _push2, _parent2, _scopeId) => {
                        if (_push2) {
                           ...
                           return [createTextVNode(toDisplayString(res.attributes.title), 1)]
                        }
                     }),
                     _: 2,
                  },
            ...
            _push(
               ssrRenderComponent(
                  _component_NuxtLink,
                  {
                     to:
                        "/app/" +
                        res.attributes.api_country_code +
                        "/" +
                        res.id +
                        "/" +
                        ((_a = res.attributes.default_prayer_time_city.data) == null
                           ? void 0
                           : _a.attributes.api_city_code),
                     key: res.id,
                  },
                  {
                     default: withCtx((_, _push2, _parent2, _scopeId) => {
                                 ...
                                 null,
                                 {
                                       ...
                                       if (_push3) {
                                          _push3(
                                             `<img${ssrRenderAttr(
                                                "src",
                                                unref(domain) +
                                                   res.attributes.flag.data.attributes.url,
                                             )} alt="" class="size-[64px] aspect-square rounded-full"${_scopeId2}>`,
                                          )
                                       } else {
                                          return [
                                             createVNode(
                                    ...
                                    text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                       if (_push3) {
                                          ...
                                          return [
                                             createTextVNode(
                                                toDisplayString(res.attributes.name),
                                                1,
                                             ),
                                          ]
                                       }
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
   _push(
      `<div${ssrRenderAttrs(
         mergeProps({ class: "flex gap-4 justify-center flex-wrap" }, _attrs),
      )}><!--[-->`,
   )
   ssrRenderList(2, (index) => {
      _push(
         `<img class="w-[284px] h-[236px] max-lg:hidden" src="https://via.placeholder.com/284x236">`,
      )
   })
   _push(
      `<!--]--><img class="w-[284px] h-[236px] lg:hidden" src="https://via.placeholder.com/284x236"><img class="w-[284px] h-[236px] max-sm:hidden" src="https://via.placeholder.com/284x236"></div>`,
   )
}
...
const _sfc_main$1 = {
   ...
   async setup(__props) {
      ...
      const { data: landingData } =
         (([__temp, __restore] = withAsyncContext(() =>
            useFetch(domain + landing + locale.value, "$kVFq4nY7UB"),
         )),
         (__temp = await __temp),
         __restore(),
         __temp)
      ...
      const activeBanners = landingData.value.data.attributes.features.filter(
      ...
      return (_ctx, _push, _parent, _attrs) => {
         _push(
            ...
            )}><div class="cent cent__col"><h2 class="h__primary">\u0645\u0632\u0627\u064A\u0627 \u0628\u0631\u0627\u064A\u0631 \u0646\u0627\u0648.</h2><p class="w-[236px] h-6 text-zinc-500 text-xs font-normal leading-[35px]"> \u0627\u062D\u0635\u0644 \u0639\u0644\u0649 \u062A\u0646\u0628\u064A\u0647 \u0645\u0648\u0627\u0642\u064A\u062A \u0627\u0644\u0635\u0644\u0627\u0629 \u0639\u0644\u0649 \u0647\u0627\u062A\u0641\u0643 \u0645\u062C\u0627\u0646\u064B\u0627.</p></div><div class="grid md:grid-cols-3 gap-4 gap-y-10"><!--[-->`,
         )
         ssrRenderList(unref(randomThreeItems), (item, index) => {
            _push(
               `<div class="grid grid-rows-3 justify-center items-center"><img${ssrRenderAttr(
                  "src",
                  unref(domain) + item.icon.data.attributes.url,
               )}${ssrRenderAttr(
                  "alt",
                  item.icon.data.attributes.name,
               )} class="rounded-sm max-w-[60px] max-h-[60px] justify-self-center"><div class="text-center text-indigo-900 text-[25px] font-normal">${ssrInterpolate(
                  item.title,
               )}</div><div class="md:max-w-[229px] max-w-72 text-center text-neutral-500 text-xs font-normal leading-5">${ssrInterpolate(
                  item.description,
               )}</div></div>`,
            )
         })
...
const _sfc_main = {
   ...
   async setup(__props) {
      ...
      const { data: landingData } =
         (([__temp, __restore] = withAsyncContext(() =>
            useFetch(domain + landing + locale.value, "$8vRqDRoJpl"),
         )),
         (__temp = await __temp),
         __restore(),
         __temp)
      ...
      return (_ctx, _push, _parent, _attrs) => {
         ...
         _push(
            `<div${ssrRenderAttrs(
               mergeProps(
                  { class: "bg-white rounded-xl border border-gray-200 px-4 py-6" },
                  _attrs,
               ),
            )}><div class="grid md:grid-cols-2 gap-2"><div class="flex items-center"><div class="grid gap-2 max-md:justify-items-center"><p class="max-md:text-center text-zinc-700 text-[15px] font-normal">${ssrInterpolate(
               unref(activeOne).sub_title,
            )}</p><h2 class="h__primary max-md:text-center">${ssrInterpolate(
               unref(activeOne).title,
            )}</h2><div class="w-full flex gap-3 items-center flex-wrap justify-center mt-4">`,
         )
         _push(
            ssrRenderComponent(
               _component_NuxtLink,
         ...
         _push(
            `</div></div></div><div class="cent"><img${ssrRenderAttr(
               "src",
               unref(domain) + unref(activeOne).image.data.attributes.url,
            )} alt="" class="rounded"></div></div></div>`,
         )
      }
   },
}
...
//# sourceMappingURL=NativePanners-BhyqnIoU.mjs.map
