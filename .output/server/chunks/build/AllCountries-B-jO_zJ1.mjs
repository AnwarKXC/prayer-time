      ...
      if (countries.value && countries.value.data.length > 0) {
        ...
        ssrRenderList(countries.value.data, (res) => {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/app/prayer-time/${res.attributes.slug}/${(_a2 = res.attributes.default_prayer_time_city.data) == null ? void 0 : _a2.attributes.slug}/${res.id}/${res.attributes.api_country_code}/${(_b2 = res.attributes.default_prayer_time_city.data) == null ? void 0 : _b2.attributes.api_city_code}/${(_c2 = res.attributes.default_prayer_time_city.data) == null ? void 0 : _c2.id}`,
            key: res.id
          }, {
...
//# sourceMappingURL=AllCountries-B-jO_zJ1.mjs.map
