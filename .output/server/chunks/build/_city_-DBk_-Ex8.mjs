import { u as useI18n, b as useRoute, h as useAsyncData, d as useFetch, e as __nuxt_component_1$4, f as __nuxt_component_2$1, a as __nuxt_component_0$2 } from './server.mjs';
import { _ as __nuxt_component_1, a as __nuxt_component_3, b as __nuxt_component_4, c as __nuxt_component_5, d as __nuxt_component_8, e as __nuxt_component_11, f as __nuxt_component_12 } from './PopularArticlesSec-CHsaJ8sY.mjs';
import { _ as __nuxt_component_0, a as __nuxt_component_3$1, b as __nuxt_component_5$1, c as __nuxt_component_6 } from './NativePanners-BdrjfFjV.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: cleander, watch } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "cleander",
      async () => $fetch(times + route.params.city + "&country=" + route.params.cityKey),
      {
        lazy: false
      }
    ...
    const { data: cities } = ([__temp, __restore] = withAsyncContext(() => useFetch(domain + getAllCitiesInCountry + route.params.countryKey + "&locale[0]=" + locale.value, "$XZS20xtOLo")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="grid gap-2">`);
      ...
      if (unref(cities) && unref(cities).data.length) {
        ...
        ssrRenderList(unref(cities).data, (city) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/app/prayer-time/" + unref(route).params.country + "/" + city.attributes.slug + "/" + unref(route).params.countryKey + "/" + unref(route).params.cityKey + "/" + city.attributes.api_city_code,
            key: city.id,
            class: "w-full"
          }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/app/prayer-time/[country]/[id]/[countryKey]/[cityKey]/[city].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_city_-DBk_-Ex8.mjs.map
