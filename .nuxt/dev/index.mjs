...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/quran/nuxt-app/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/quran/nuxt-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/quran/nuxt-app/node_modules/devalue/index.js';
import destr from 'file://D:/quran/nuxt-app/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://D:/quran/nuxt-app/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://D:/quran/nuxt-app/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://D:/quran/nuxt-app/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/quran/nuxt-app/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/quran/nuxt-app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/quran/nuxt-app/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/quran/nuxt-app/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/quran/nuxt-app/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/quran/nuxt-app/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://D:/quran/nuxt-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/quran/nuxt-app/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/quran/nuxt-app/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/quran/nuxt-app/node_modules/consola/dist/index.mjs';
import devalue from 'file://D:/quran/nuxt-app/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://D:/quran/nuxt-app/node_modules/unctx/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/quran/nuxt-app/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://D:/quran/nuxt-app/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file://D:/quran/nuxt-app/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/quran/nuxt-app/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/quran/nuxt-app/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/quran/nuxt-app/server/assets"}];
...
const _sWvHhpiGNR = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/quran/nuxt-app";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _p7AdlqsewP = (nitroApp) => {
...
const _lazy_7ckoJ3 = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://D:/quran/nuxt-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/quran/nuxt-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
