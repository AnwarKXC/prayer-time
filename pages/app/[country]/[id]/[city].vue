	...
	<div class=" grid gap-6">
		...
		<div class=" bg-white rounded-[10px] border border-gray-200 px-4 py-6 grid gap-6">
			...
			<div class="city__label__grid">
				<NuxtLink :to=" '/app/' + route.params.country + '/' + route.params.id + '/' + city.id "
					v-for="                         city                         in                        cities.data                        "
...
const { data: cities } = await useFetch( domain + getAllCitiesInCountry + route.params.id + '&locale[0]=' + locale.value )
